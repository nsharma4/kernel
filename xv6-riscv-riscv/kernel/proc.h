...
struct cpu {
  ...
  // added
  int running_procs;          // Number of running processes
  int sleeping_procs;         // Number of sleeping processes
  uint64 current_tick_interval; // Current tick interval for this CPU
};
...
struct proc {
  ...
  // added
  uint64 run_ticks;           // How many ticks this process has been running
  uint64 sleep_ticks;         // How many ticks this process has been sleeping
  uint64 runnable_ticks;      // How many ticks this process has been runnable
  uint64 last_tick;           // Last tick when state changed
